...
public class SecureStorageTest extends MockitoTestCase {
   ...
   // Context context = Mockito.mock(Context.class);
    ...
    protected void setUp() throws Exception {
        ...
        mSecureStorage = new SecureStorage(context, SecureStorageInterface.DEVICE_FILE);
    ...
    public void testStoreValueForKey() throws Exception {
        ...
        assertNull(mSecureStorage.storeValueForKey("key", ""));
        ...
        assertNotSame(mSecureStorage.storeValueForKey("key", "value"), mSecureStorage.storeEncryptedData("key", "value"));
        }
