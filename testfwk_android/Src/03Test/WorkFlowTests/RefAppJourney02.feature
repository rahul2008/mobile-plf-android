...
Scenario: RefAppJourney02
	...
	And the user can see dots (navigation/page control) on the bottom.
	...
	And the user Skip and Done should not be together	
	...
	Then verify that the user has not selected the Receive promotional 
