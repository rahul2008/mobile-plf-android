...
namespace Philips.MRAutomation.Foundation.LoggingUtility
{
    ...
    /// 
    /// </summary>
    public class DiskSpaceLog
    {
        /// <summary>
        /// 
        /// </summary>
        public static string diskSpaceLogFile = string.Empty;
        ...
        public static void Create ()
        {
            try
            {
                diskSpaceLogFile = "Reports\\DiskSpaceInfo" + ".csv";
                if (!File.Exists(diskSpaceLogFile))
                {
                    TextWriter tw = new StreamWriter(diskSpaceLogFile);
                    //Get the drives
                    //string s = "TestCase,DateTime" + 
                    //tw.WriteLine(s);
                    tw.Close();
                }
            }
