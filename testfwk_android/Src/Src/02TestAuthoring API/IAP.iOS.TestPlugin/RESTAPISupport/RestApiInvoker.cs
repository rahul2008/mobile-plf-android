...
namespace Philips.SIG.Automation.iOS.CDPP.IAPTestPluginForiOS
{
    ...
    public class RestApiInvoker
    {
        ...
        //    endPoint = ConfigurationManager.AppSettings["BaseURLforRESTCalls"] + "v2/US_Tuscany/products/" + productId;
        //    string contentType = "text/json";
        //    RestClientExtended restObj = new RestClientExtended(endPoint, HttpVerb.GET, contentType, "");
        //    parameters = "";
        //    response = restObj.MakeRequest(parameters);
        //    PaymentDetails root = JsonConvert.DeserializeObject<PaymentDetails>(response);
        //    return root;
        }
