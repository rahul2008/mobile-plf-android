...
PairingListener, DiscoveryEventListener, NetworkStateListener, InternetConnectionListener {
	...
	public void onPairingSuccess(NetworkNode networkNode) {	
		...
		getCurrentPurifier().setNotificationsPermissionEnabled(NotificationPermission.PERMISSION_ENABLED.getNotificationPermission());
		DiscoveryManager.getInstance().updateApplianceInDatabase(getCurrentPurifier()) ;
