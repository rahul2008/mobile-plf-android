...
public class MarkerActivity extends MapActivity implements OnMapLoadedListener, OutdoorDetailsListener {
	...
	protected void onResume() {
		...
		OutdoorManager.getInstance().setOutdoorDetailsListenerForMap(this);
	}
	...
	protected void onPause() {
		...
		OutdoorManager.getInstance().removeOutdoorDetailsListenerForMap();
	}
	...
	private void addMarkerCurrentPurifer() {
		...
		if (currentPurifier.getAirPort().getPortProperties() != null) {
			currentPurifierAQI = currentPurifier.getAirPort().getPortProperties()
					.getIndoorAQI();
