...
public class FirmwareUpdateTask extends AsyncTask<String, Void, String> {
	...
	public FirmwareUpdateTask(FirmwareResponseListener listener, PurAirDevice purifier) {
	...
	protected String doInBackground(String... firmwareUrl) {
		...
		if (responseObj != null) {
			result = new DISecurity(null).decryptData(responseObj.getResponseData(), purifier);
		}
		return result;
	}
