...
public class EWSWifiManager {
    ...
    /**
    * Taken from: http://stackoverflow.com/questions/20551658/disabling-samsung-auto-network-switch-for-wifi-connection
    * Checks whether the "Avoid poor networks" setting (named "Auto network switch" on 
     * some Samsung devices) is enabled, which blocks connection with the Soft-access point during speaker setup.
    *
...
//        } 
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR1) {
            //As of JELLY_BEAN_MR1, a constant was added to WifiWatchdogStateMachine to determine 
            ...
            //Prior to JELLY_BEAN_MR1, the default for the Avoid Poor Networks setting was
