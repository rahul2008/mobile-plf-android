...
public class ServiceDiscoveryManager implements ServiceDiscoveryInterface {
        ...
        if (null != mAppInfra.getRestClient() && !mAppInfra.getRestClient().isInternetReachable()) {
            ...
            if (urlBuild != null) {
                ...
                if (service.isSuccess()) {
                    ...
                    appInfraTaggingAction.trackSuccessAction(SERVICE_DISCOVERY, SD_SUCCESS);
    ...
    public URL applyURLParameters(URL inputURL, Map<String, String> parameters) {
        ...
        try {
            ...
            appInfraTaggingAction.trackErrorAction(SERVICE_DISCOVERY, MALFORMED_URL);
            return null;
        }
    }
    ...
    private String getCountryCodeFromSim() {
        try {
            ...
            appInfraTaggingAction.trackErrorAction(SERVICE_DISCOVERY, COUNTRY_CODE_SIM_ERROR);
        }
        return countryCode;
    }
