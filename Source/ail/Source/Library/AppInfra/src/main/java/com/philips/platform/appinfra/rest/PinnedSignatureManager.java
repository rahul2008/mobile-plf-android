...
class PinnedSignatureManager implements PublicKeyPinInterface {
    ...
    public void updatePinnedPublicKey(String hostName, String networkPublicKeyDetails) {
        ...
        if (!hostName.isEmpty()) {
            if (!isKeyFound && storedPublicKeyDetails != null) {
                ...
                if (storedPublicKeyDetails == null) {
                    ...
                    for (String publicKey : publicKeys) {
                        if (storedPublicKeyDetails.contains(publicKey)) {
                            ...
                            checkPinnedPublicKeyValidity(currentPinsExpiryDate, storedPinsExpiryDate);
                            return;
                        }
                    }
    ...
    private void checkPinnedPublicKeyValidity(String currentPinsExpiryDate, String storedPinsExpiryDate) {
