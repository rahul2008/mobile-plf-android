...
public class WelcomeFragmentPresenterTest extends TestCase {
    ...
    public void testOnClick() throws Exception {
        ...
        when(uiFlowManagerMock.getNextState(appFrameworkApplicationMock.getTargetFlowManager().getCurrentState(), "welcome_skip")).thenReturn(userRegStateMock);
    ...
    public void testOnBackPress() throws Exception {
        ...
        when(appFrameworkApplicationMock.getTargetFlowManager()).thenReturn(uiFlowManagerMock);
        when(appFrameworkApplicationMock.getTargetFlowManager().getCurrentState()).thenReturn(welcomeState);
        when(uiFlowManagerMock.getNextState(appFrameworkApplicationMock.getTargetFlowManager().getCurrentState(), "welcome_home")).thenReturn(homeTabbedActivityStateMock);
