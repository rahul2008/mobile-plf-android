...
public class OrmMeasurement implements Measurement, Serializable {
    ...
    private com.philips.platform.appframework.database.table.OrmMoment ormMoment;
    ...
    @Override
    public Collection<? extends com.philips.platform.appframework.database.table.OrmMeasurementDetail> getMeasurementDetails() {
        return ormMeasurementDetails;
    }

    @Override
    public void addMeasurementDetail(final MeasurementDetail measurementDetail) {
        ormMeasurementDetails.add((com.philips.platform.appframework.database.table.OrmMeasurementDetail) measurementDetail);
    }
