...
public class UIConstants {
     ...
     */
    @IntDef({UI_COCO_USER_REGISTRATION, UI_COCO_PRODUCT_REGISTRATION, UI_COCO_IN_APP_PURCHASE, UI_COCO_CONSUMER_CARE, UI_COCO_APP_CHASSIS, UI_COCO_IN_APP_PURCHASE_HISTORY})
    ...
    public static final int UI_COCO_IN_APP_PURCHASE_HISTORY = 2006;

    /**
     * Constants fo each UI screen
     */
    @IntDef({UI_SPLASH_SCREEN, UI_WELCOME_SCREEN, UI_HAMBURGER_SCREEN, UI_USER_REGISTRATION_SCREEN, UI_SETTINGS_SCREEN, UI_DEBUG_SCREEN, UI_SUPPORT_SCREEN,UI_HOME_SCREEN, UI_IAP_SHOPPING_SCREEN, UI_IAP_SHOPPING_HISTORY_SCREEN})
    @Retention(RetentionPolicy.SOURCE)
    ...
    public static final int UI_IAP_SHOPPING_HISTORY_SCREEN = 3010;
