...
public class CirclePageIndicator extends View implements PageIndicator {
    ...
    public float getUnSelectedRadius() {
        return unSelectedRadius;
    }

    public void setUnSelectedRadius(final float unSelectedRadius) {
    ...
    public boolean isEnableStrokeBackground() {
        return enableStrokeBackground;
    }

    public void setEnableStrokeBackground(final boolean enableStrokeBackground) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int iLoop = 0; iLoop < count; iLoop++) {
            ...
            mPaintUnselectedFill.setAlpha((int) 178.5);
            if (pageFillRadius != mRadius) {
                if (!enableStrokeBackground)
                    canvas.drawCircle(dX, dY, unSelectedRadius, mPaintUnselectedFill);
                else
                    canvas.drawCircle(dX, dY, unSelectedRadius, mPaintStroke);
            }
        }
