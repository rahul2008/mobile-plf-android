 ...
 */
public class PhilipsRatingBarSmall extends RatingBar {

    public PhilipsRatingBarSmall(Context context) {
        super(context);
        Log.i("Spoorti", "Inside Consturctor 1");
    }

    public PhilipsRatingBarSmall(Context context, AttributeSet attributeSet) {
    ...
    protected synchronized void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (this != null) {
            ...
            final int width = (int) (getContext().getResources().getDimension(R.dimen.star_width_small));
            final int height = (int) (getContext().getResources().getDimension(R.dimen.star_height_small));
