 ...
 * All rights reserved.
 */
public class SplashScreenTabletTest extends ActivityInstrumentationTestCase2<MainActivity> {

    private Resources testResources;

    public SplashScreenTabletTest() {
    ...
    public void testSplashScreenLogoAsExpected() {
        ...
        Bitmap expectedBitmap = BitmapFactory.decodeResource(testResources, com.philips.cdp.ui.catalog.test.R.drawable.philips_shield_tablet);
    ...
    public void testSplashScreenTitleAsExpected() {
        ...
        onView(withId(R.id.splash_title))
                .check(matches(isTextSizeSimilar(testResources.getDimension(com.philips.cdp.ui.catalog.test.R.dimen.splash_title_text_size_tablet))));
    }
