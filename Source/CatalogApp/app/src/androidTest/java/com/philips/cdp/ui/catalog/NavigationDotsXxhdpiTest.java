 ...
 * All rights reserved.
 */
public class NavigationDotsXxhdpiTest extends ActivityInstrumentationTestCase2<MainActivity> {

    private Resources testResources;

    public NavigationDotsXxhdpiTest() {
    ...
    public void testNDotFocusedUnfocusedRadiusAsExpected() {
        ...
        onView(withId(R.id.indicator))
                .check(matches(isCircleRadiusSimilar(18, 11)));
    }
}
