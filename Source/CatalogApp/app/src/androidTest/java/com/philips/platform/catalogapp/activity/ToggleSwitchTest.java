...
/*
    ...
    public void verifyToggleSwitchStrokeWidth() {
        GradientDrawableCompat.StateColors stateColors = GradientDrawableCompat.getStateColors(thumbDrawable);
    ...
    public void verifyCornerRadius() {
        GradientDrawableCompat.StateColors stateColors = GradientDrawableCompat.getStateColors(trackDrawable);
    ...
    public void verifyToggleSwitchCheckedColorTest() {
        GradientDrawableCompat.StateColors stateColors = GradientDrawableCompat.getStateColors(toggleSwitch.getTrackDrawable());
        int baseColor = ThemeColorUtils.getAttributeColor(mActivityTestRule.getActivity(), R.attr.uikit_baseColor);
