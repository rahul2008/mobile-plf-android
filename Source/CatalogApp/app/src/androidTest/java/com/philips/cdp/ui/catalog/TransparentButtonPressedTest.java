 ...
 * All rights reserved.
 */
public class TransparentButtonPressedTest extends ActivityInstrumentationTestCase2<MainActivity> {
    ...
    public void testDBThemePressedTButtonOutlineColourAsExpected() {
        ...
        matchPressedOutlineColor(R.id.outlined_transparent_button, "#f204b");
    }
    ...
    public void testDBThemePressedTButtonTextColourAsExpected() {
        ...
        setTargetActivity(monitor);
        setPressed(R.id.outlined_transparent_button, true);
        matchPressedTextColor(R.id.outlined_transparent_button, "#f204b");
    }
    ...
    public void testBOThemePressedTButtonOutlineColourAsExpected() {
        ...
        setTargetActivity(monitor);
        setPressed(R.id.outlined_transparent_button, true);
        matchPressedOutlineColor(R.id.outlined_transparent_button, "#983222");
    }
    ...
    public void testBOThemePressedTButtonTextColourAsExpected() {
        ...
        setTargetActivity(monitor);
        setPressed(R.id.outlined_transparent_button, true);
        matchPressedTextColor(R.id.outlined_transparent_button, "#983222");
    }
    ...
    public void testBAThemePressedTButtonOutlineColourAsExpected() {
        ...
        setTargetActivity(monitor);
        setPressed(R.id.outlined_transparent_button, true);
        matchPressedOutlineColor(R.id.outlined_transparent_button, "#156570");
    }
    ...
    public void testBAThemePressedTButtonTextColourAsExpected() {
        ...
        setTargetActivity(monitor);
        setPressed(R.id.outlined_transparent_button, true);
        matchPressedTextColor(R.id.outlined_transparent_button, "#156570");
    }
