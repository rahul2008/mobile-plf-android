...
public class THSCustomButtonWithDrawableIcon extends Button {
    ...
    public THSCustomButtonWithDrawableIcon(Context context) {
        super(context);
        init(context, null);
    }

    public THSCustomButtonWithDrawableIcon(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public THSCustomButtonWithDrawableIcon(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context, AttributeSet attrs) {
        if (attrs != null) {
            TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.thsCenterIconButton);
            tintColor = typedArray.getColor(R.styleable.thsCenterIconButton_drawableTint, Color.TRANSPARENT);
            float defaultDrawablePadding = getResources().getDimension(R.dimen.ths_4_dp);
            int drawablePadding = (int) typedArray.getDimension(R.styleable.thsCenterIconButton_android_drawablePadding, defaultDrawablePadding);
