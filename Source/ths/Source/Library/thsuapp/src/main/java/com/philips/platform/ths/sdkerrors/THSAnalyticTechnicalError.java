...
public class THSAnalyticTechnicalError {
    ...
    public static final String ANALYTICS_ENROLLMENT_MANGER = "EnrollmentManager";
    ...
    public static final String ANALYTICS_FETCH_HEALTH_SUBSCRIPTION = "Fetch health Plaan subcription";
    public static final String ANALYTICS_UPDATE_HEALTH_PLAN = "Update health plans";
    public static final String ANALYTICS_FETCH_APPOINTMENTS = "Fetch appointments";
    public static final String ANALYTICS_CANCEL_APPOINTMENT = "Cancel appointment";
    public static final String ANALYTICS_FETCH_MEDICATION = "Fetch medication";
    ...
    public static final String ANALYTIC_FETCH_PROVIDER = "Fetch provider";
    public static final String ANALYTIC_FETCH_SUMMARY = "Fetch summary";
    public static final String ANALYTIC_FETCH_VISIT_HISTORY = "Fetch visit history";
    public static final String ANALYTIC_FETCH_PROVIDER_IMAGE = "Fetch provider image";
    public static final String ANALYTIC_FETCH_PRACTICE = "Fetch practice";
    public static final String ANALYTIC_FETCH_PRACTICE_IMAGE = "Fetch practice image";
