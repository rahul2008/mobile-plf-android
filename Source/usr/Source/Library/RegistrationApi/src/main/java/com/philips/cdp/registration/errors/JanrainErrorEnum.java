...
public enum JanrainErrorEnum {
    ...
    JANRAIN_EMAIL_ADDRESS_NOT_AVAILABLE(ErrorCodes.JANRAIN_EMAIL_ADDRESS_NOT_AVAILABLE, R.string.reg_Janrain_Invalid_Credentials_ErrorMsg),
    ...
    JANRAIN_ATTRIBUTE_CONSTRAINT_LENGHT_VIOLATION(ErrorCodes.JANRAIN_ATTRIBUTE_CONSTRAINT_LENGHT_VIOLATION, R.string.reg_MaxiumCharacters_ErrorMsg),
    ...
    private static String getJanrainFormattedError(Context context, int errorCode) {
        ...
        if(stringId == R.string.reg_JanRain_Server_ConnectionLost_ErrorMsg){
            return String.format(context.getString(getStringId(errorCode)),context.getString(R.string.reg_USR_Error_PleaseTryLater_Txt)) + "["+errorCode+"]" +".";
        }else if (stringId == R.string.reg_Janrain_Invalid_Credentials_ErrorMsg){
            return context.getString(R.string.reg_JanRain_Invalid_Credentials);
        }else if (stringId == R.string.reg_Janrain_EntityAlreadyExists_ErrorMsg){
        ...
        }else if (stringId == R.string.reg_Janrain_AuthorizationCodeExpired_ErrorMsg){
            return String.format(context.getString(getStringId(errorCode)),context.getString(R.string.reg_UnexpectedInternalError_ErrorMsg));
        }
