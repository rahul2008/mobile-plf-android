...
class CoppaConfiguration {
    ...
    /**
     * {@code getCurrentConsentsArray}method get jsonArray
     *
     * @return consents will return json Array
     */
    ...
    /**
     * {@code clearConfiguration} method clear the Configuration
     */
    ...
    /**
     * {@code consentIndex} method give the index value
     *
     * @return consentIndex will return number
     */
    ...
    /**
     * {@code isCampaignIdPresent} method give the boolean value
     *
     * @return isCampaignIdPresent will return true or false
     */
    ...
    /**
     * {@code getCoopaConfigurationFlields} method give the JsonObject of coopa configration fildes
     *
     * @param jsonObject get Json object value
     */
