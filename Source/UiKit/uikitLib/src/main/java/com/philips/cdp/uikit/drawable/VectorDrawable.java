...
public class VectorDrawable extends Drawable {
    ...
    public void inflate(Resources res, XmlPullParser parser, AttributeSet attrs, Theme theme)
        ...
        final TypedArray a = obtainAttributes(res, theme, attrs, R.styleable.VectorCompat);
        updateStateFromTypedArray(a);
        a.recycle();
...
//        state.mThemeAttrs = a.extractThemeAttrs();
        ...
        pathRenderer.mBaseWidth = a.getDimension(
                R.styleable.VectorCompat_android_width, pathRenderer.mBaseWidth);
        pathRenderer.mBaseHeight = a.getDimension(
                R.styleable.VectorCompat_android_height, pathRenderer.mBaseHeight);
        ...
        final float alphaInFloat = a.getFloat(R.styleable.VectorCompat_android_alpha,
                pathRenderer.getAlpha());
        pathRenderer.setAlpha(alphaInFloat);

        final String name = a.getString(R.styleable.VectorCompat_android_name);
        if (name != null) {
...
//            mThemeAttrs = a.extractThemeAttrs();
            ...
            mRotate = a.getFloat(R.styleable.VectorCompatGroup_android_rotation, mRotate);
            mPivotX = a.getFloat(R.styleable.VectorCompatGroup_android_pivotX, mPivotX);
    ...
    private static class VClipPath extends VPath {
        ...
        public void inflate(Resources r, AttributeSet attrs, Theme theme) {
            final TypedArray a = obtainAttributes(r, theme, attrs,
                    R.styleable.VectorCompatClipPath);
            updateStateFromTypedArray(a);
            a.recycle();
        }
...
//            mChangingConfigurations |= getChangingConfigurations(a);
            ...
            final String pathName = a.getString(R.styleable.VectorCompatClipPath_android_name);
            if (pathName != null) {
                mPathName = pathName;
            }
    ...
    private static class VFullPath extends VPath {
        ...
        public void inflate(Resources r, AttributeSet attrs, Theme theme) {
            final TypedArray a = obtainAttributes(r, theme, attrs,
                    R.styleable.VectorCompatPath);
            updateStateFromTypedArray(a, theme);
            a.recycle();
        }

        private void updateStateFromTypedArray(TypedArray a, Theme theme) {
            // Account for any configuration changes.
//            mChangingConfigurations |= getChangingConfigurations(a);
//
            // Extract the theme attributes, if any.
//            mThemeAttrs = a.extractThemeAttrs();
            ...
            final String pathName = a.getString(R.styleable.VectorCompatPath_android_name);
            if (pathName != null) {
                mPathName = pathName;
            }
