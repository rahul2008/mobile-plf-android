...
public class InsightDataSenderTest {
    ...
    @Test
    public void shouldNotSendData_WhenDataSenderIsBusy() {
    ...
    @Test
    public void shouldNotSendDataToBackEnd_WhenUserIsNotLoggedIN() {
    ...
    @Test
    public void shouldSendDataToBackEnd_WhenUserIsLoggedInAndDataIsNotEmpty() {
    ...
    @Test
    public void shouldThrowError_WhenDeleteInsightfails() {
    ...
    @Test
    public void shouldReturnInsightClass_WhenGetClassForSyncDataIsCalled() {
