...
public class SHNCapabilityNotificationsWrapper implements SHNCapabilityNotifications {
    ...
    @Override
    public void setAlarm(final TransferGetCapabilitiesWithResult transferGetCapabilitiesWithResult, final int hours_u, final int minutes_u, final boolean repeatNotification, final short lifeTimeSeconds_u,
