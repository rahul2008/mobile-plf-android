...
public interface SHNDeviceDefinitionInfo {
    ...
    /**
     * Specifies an association procedure to be used to associate with the peripheral. The procedure will be used by {@link com.philips.pins.shinelib.SHNDeviceAssociation}.
     *
     ...
     * <p/>
     * If true then {@code matchesOnAdvertisedData} is used to determine if the advertised data received from a peripheral matches what is supported by the plugin. Otherwise
     * the matching should be done using the UUID's obtained through the {@code getPrimaryServiceUUIDS} function.
     *
