 ...
 * @publicPluginApi
 */
public class SHNDeviceImpl2 implements SHNService.SHNServiceListener, SHNDevice, SHNCentral.SHNCentralListener, SHNService.CharacteristicDiscoveryListener {
    ...
    private static final String TAG_BASE = SHNDeviceImpl2.class.getSimpleName();
    ...
    public SHNDeviceImpl2(BTDevice btDevice, SHNCentral shnCentral, String deviceTypeName) {
        this(btDevice, shnCentral, deviceTypeName, false);
    }

    @Deprecated
    public SHNDeviceImpl2(BTDevice btDevice, SHNCentral shnCentral, String deviceTypeName, boolean deviceBondsDuringConnect) {
        this(btDevice, shnCentral, deviceTypeName, deviceBondsDuringConnect ? SHNBondInitiator.PERIPHERAL : SHNBondInitiator.NONE);
    }

    public SHNDeviceImpl2(BTDevice btDevice, SHNCentral shnCentral, String deviceTypeName, SHNBondInitiator shnBondInitiator) {
    ...
    private void handleGattDisconnectEvent() {
        ...
        if (internalState == InternalState.GattConnecting && delta < timeOut) {
            ...
            shnCentral.unregisterBondStatusListenerForAddress(SHNDeviceImpl2.this, getAddress());
            shnCentral.unregisterSHNCentralStatusListenerForAddress(SHNDeviceImpl2.this, getAddress());
        }
    }
    ...
    private BTGatt.BTGattCallback btGattCallback = new BTGatt.BTGattCallback() {
        ...
        public void onReadRemoteRssi(BTGatt gatt, int rssi, int status) {
            SHNDeviceImpl2.this.shnDeviceListener.onReadRSSI(rssi);
        }
