...
public class CapabilityDiCommWrapper implements CapabilityDiComm, ResultListener<SHNStreamData> {
    ...
    private Set<ResultListener<SHNStreamData>> streamDataResultListenersSet;
    ...
    @Override
    public void addDataListener(@NonNull final ResultListener<SHNStreamData> dataRawResultListener) {
        streamDataResultListenersSet.add(dataRawResultListener);
    }

    @Override
    public void removeDataListener(@NonNull ResultListener<SHNStreamData> dataRawResultListener) {
        streamDataResultListenersSet.remove(dataRawResultListener);
    }

    @Override
    public void onActionCompleted(final SHNStreamData value, @NonNull final SHNResult result) {
        userHandler.post(new Runnable() {
            @Override
            public void run() {
                for (ResultListener<SHNStreamData> dataRawResultListener : streamDataResultListenersSet) {
