...
public class ErrorDialogFragment extends DialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.mec_error_dialog, container, false);
        initializeViews(v);
        return v;
    }
    ...
    void initializeViews(View v) {
        ...
        dialogTitle.setText(bundle.getString(MECConstant.SINGLE_BUTTON_DIALOG_TITLE));

        final TextView dialogDescription = v.findViewById(R.id.dialogDescription);
        dialogDescription.setText(bundle.getString(MECConstant.SINGLE_BUTTON_DIALOG_DESCRIPTION));

        Button mOkBtn = v.findViewById(R.id.btn_dialog_ok);
        mOkBtn.setText(bundle.getString(MECConstant.SINGLE_BUTTON_DIALOG_TEXT));
    ...
    private void handleEmptyScreen() {
        if (bundle.getString(MECConstant.SINGLE_BUTTON_DIALOG_DESCRIPTION) != null
                && bundle.getString(MECConstant.SINGLE_BUTTON_DIALOG_DESCRIPTION).equals(getString(R.string.mec_something_went_wrong))) {
