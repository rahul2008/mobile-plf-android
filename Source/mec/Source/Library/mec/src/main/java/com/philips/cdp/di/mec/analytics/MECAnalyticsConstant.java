...
public class MECAnalyticsConstant {

    private MECAnalyticsConstant(){

    }

    public static final String COMPONENT_NAME = "mec";
    ...
    public static final String RETAILER_WEB_PAGE = "RetailerWebPage";
    ...
    public static final String SHIPPING_ADDRESS_SELECTION_PAGE_NAME = "ShippingAddressSelectionPage";
