...
import com.philips.cdp.di.mec.address.AddressFields;
import com.philips.cdp.di.mec.container.CartModelContainer;
import com.philips.cdp.di.mec.model.Addresses;
...
import static com.philips.cdp.di.mec.utils.NetworkUtility.ALERT_DIALOG_TAG;
...
public class Utility {
    ...
    public static String getFormattedDate(String date) {
        ...
        try {
            ...
            MECLog.d(Utility.TAG, e.getMessage());
        }
...
//    }
    ...
    protected static void appendAddressWithNewLineIfNotNull(StringBuilder sb, String code) {
        ...
        if (!TextUtils.isEmpty(code)) {
            ...
            sb.append(addressLine1ReplacingNullValue).append(MECConstant.NEW_LINE_ESCAPE_CHARACTER);
        }
    }
...
//    }
    ...
    public static Drawable getImageArrow(Context mContext) {
        ...
        Drawable imageArrow = VectorDrawableCompat.create(mContext.getResources(), R.drawable.mec_product_count_drop_down, mContext.getTheme());
        ...
        try {
            ...
            if (voucherCodeEnabledObject != null) {
                if (voucherCodeEnabledObject instanceof Boolean) {
                    ...
                    MECLog.e(MECLog.LOG,"voucherCode.enable instance should be boolean value true or false");
                }
            }else{
                return MECUtility.getInstance().isVoucherEnable();
            }
        } catch (IllegalArgumentException illegalArgumentException) {
            MECLog.e(MECLog.LOG, "IllegalArgumentException while voucherCode enable");
        }
        return false;
    }
