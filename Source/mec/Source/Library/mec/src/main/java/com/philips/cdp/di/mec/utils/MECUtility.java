...
import com.philips.cdp.di.mec.response.products.PaginationEntity;
...
public class MECUtility {

    private int maxCartCount;
    private MECOrderFlowCompletion mecOrderFlowCompletion;
    ...
    public void setMecOrderFlowCompletion(MECOrderFlowCompletion mecOrderFlowCompletion) {
        this.mecOrderFlowCompletion = mecOrderFlowCompletion;
    }
    ...
    private static class MECUtilitySingleton
    {
        private static final MECUtility INSTANCE = new MECUtility();
    }

    public static MECUtility getInstance()
    {
        return MECUtilitySingleton.INSTANCE;
    }
