...
import com.philips.cdp.di.mec.model.AddressFieldDecider;
...
public class MECSettings extends UappSettings {
    ...
    private MECMockInterface mecMockInterface;

    /**
     * Used to create MECSettings instance
    ...
    public MECMockInterface getMecMockInterface() {
        return mecMockInterface;
    }

    public void setMecMockInterface(MECMockInterface mecMockInterface) {
        this.mecMockInterface = mecMockInterface;
    }
}
