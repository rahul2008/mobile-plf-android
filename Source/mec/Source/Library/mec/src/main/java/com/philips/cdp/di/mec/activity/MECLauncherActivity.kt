...
class MECLauncherActivity : UIDActivity(), View.OnClickListener {
    ...
    private fun loadDecisionFragment( ){
            ...
            transaction.replace(com.philips.cdp.di.mec.R.id.container_launcher, mECFragmentLauncher, "MECFragmentLauncher")
            transaction.addToBackStack("MECFragmentLauncher")
