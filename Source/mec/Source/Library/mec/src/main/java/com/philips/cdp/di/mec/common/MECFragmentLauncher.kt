...
class MECFragmentLauncher : MecBaseFragment() {
    ...
    lateinit var mecFlows: MECLaunchInput.MECFlows
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        mecFlows = MECLaunchInput.MECFlows.values()[mecFlowOrdinal] // getting enum from previous fragment
    ...
    private fun getFragment(isHybris: Boolean, screen: MECLaunchInput.MECFlows): MecBaseFragment? {
