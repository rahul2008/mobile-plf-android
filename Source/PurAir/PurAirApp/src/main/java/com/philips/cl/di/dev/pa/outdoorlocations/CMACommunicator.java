...
public class CMACommunicator implements DataCommunicator {
	...
	public void requestAQIData(List<String> cities) {
		...
		TaskGetHttp requestAQITask = new TaskGetHttp(cmaHelper.getURL(BASE_URL_AQI, areaIds, AIR, Utils.getDate(System.currentTimeMillis())), RequestType.CITIES_AQI.getRequestTypeString(), this);
	...
	public void requestNearbyLocationsAQI(List<String> cities) {
		...
		TaskGetHttp requestAQITask = new TaskGetHttp(cmaHelper.getURL(BASE_URL_AQI, areaIds, AIR, Utils.getDate(System.currentTimeMillis())), RequestType.NEARBY_LOCATIONS_AQI.getRequestTypeString(), this);
		requestAQITask.start();
	}
	...
	public void requestWeatherData(List<String> cities) {
		...
		TaskGetHttp requestWeatherTask = new TaskGetHttp(cmaHelper.getURL(BASE_URL_WEATHER, areaIds, OBSERVE, Utils.getDate(System.currentTimeMillis())), RequestType.CITIES_WEATHER.getRequestTypeString(), this);
	...
	public void requestHistoricalAQI(String city) {
		...
		TaskGetHttp requestHistoricalAQITask = new TaskGetHttp(url,RequestType.HISTORIAL_AQI.getRequestTypeString(), city, this);
	...
	public void requestOneDayForecast(String city) {
		...
		TaskGetHttp requestOneDayForecastTask = new TaskGetHttp(BASE_URL_HOURLY_FORECAST + city + "&time=day", RequestType.FORECAST_ONE_DAY.getRequestTypeString(), this);
		requestOneDayForecastTask.start();
	}

	@Override
	public void requestFourDayForecast(String city) {
		TaskGetHttp requestFourDayForecastTask = new TaskGetHttp(cmaHelper.getURL(BASE_URL_WEATHER, city, FORECAST_4_DAYS, Utils.getDate(System.currentTimeMillis())), RequestType.FORECAST_FOUR_DAYS.getRequestTypeString(), this);
	...
	public void requestAllCitiesData(List<String> cities) {
		...
		TaskGetHttp requestAQITask1 = new TaskGetHttp(cmaHelper.getURL(BASE_URL_AQI, areaIds1, AIR, Utils.getDate(System.currentTimeMillis())), RequestType.ALL_CITIES_AQI.getRequestTypeString(), this);
		requestAQITask1.start();
		
		TaskGetHttp requestAQITask2 = new TaskGetHttp(cmaHelper.getURL(BASE_URL_AQI, areaIds2, AIR, Utils.getDate(System.currentTimeMillis())), RequestType.ALL_CITIES_AQI.getRequestTypeString(), this);
