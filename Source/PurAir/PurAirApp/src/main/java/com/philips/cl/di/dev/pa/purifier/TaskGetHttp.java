...
public class TaskGetHttp extends Thread {
	...
	public TaskGetHttp(String url, ServerResponseListener listener) {
		ALog.i(ALog.TASK_GET, "Url: " + url);
		this.url = url ;
		this.listener = listener ;
	}

	public TaskGetHttp(String url, String type, ServerResponseListener listener) {
		this(url,listener) ;
		this.type = type ;
	}

	public TaskGetHttp(String url, String type, String areaId, ServerResponseListener listener) {
		this(url, listener) ;
		this.type = type ;
		this.areaId = areaId;
	}
