...
//	private static final String US_EMBASSY_CITY_AQI_URL = "http://222.73.255.34/pm.php?city=";
	...
	public void requestAQIData(List<String> cities) {
		for (String cityName : cities) {
			TaskGetHttp requestAQITask = new TaskGetHttp(US_EMBASSY_CITY_HISTORICAL_AQI_URL + cityName, RequestType.CITIES_AQI.getRequestTypeString(), cityName, this);
	...
	public void requestHistoricalAQI(String cityName) {
		TaskGetHttp requestAQITask = new TaskGetHttp(US_EMBASSY_CITY_HISTORICAL_AQI_URL + cityName, RequestType.HISTORIAL_AQI.getRequestTypeString(), cityName, this);
		requestAQITask.start();
	}
