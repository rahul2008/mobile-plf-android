...
public class DataSyncApplicationClass extends Application{
    ...
    protected void prepareInjectionsGraph() {
        final DatabaseModule databaseModule = new DatabaseModule(this);
        ...
        appComponent = DaggerAppComponent.builder().databaseModule(databaseModule).backendModule(backendModule).registrationModule(registrationModule)
                .coreModule(coreModule).applicationModule(applicationModule).build();
    }
