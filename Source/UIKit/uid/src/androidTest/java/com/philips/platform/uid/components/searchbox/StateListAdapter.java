...
public class StateListAdapter extends BaseAdapter implements Filterable, SearchBox.FilterQueryChangedListener, SearchBox.ExpandListener, SearchBox.QuerySubmitListener {
    ...
    private class StateListFilter extends Filter {
        ...
        protected void publishResults(CharSequence constraint, FilterResults results) {
            ...
            if ((query.length() > 0) && filteredList.size() <= 0) {
                filteredList.add(context.getResources().getString(com.philips.platform.uid.test.R.string.search_box_no_result));
            }
