...
public class AlertTest {
    ...
    public void verifyAlertContentLeftMargin() {
        ...
        int expectedLeftMargin = testResources.getDimensionPixelSize(com.philips.platform.uit.test.R.dimen.alertcontent_leftrightbottom_margin);
    ...
    public void verifyActionAreaHeight() {
        UITTestUtils.waitFor(testResources, 750);
        int expectedActionareaHeight = testResources.getDimensionPixelSize(com.philips.platform.uit.test.R.dimen.alertactionarea_height);
        getAlertActionArea()
