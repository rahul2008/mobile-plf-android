 ...
 */
public class NavigationImplModeFragment extends Fragment {

    public static final String TAG = "NavigationImplModeFragment";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle state) {
        final View flagsView = inflater.inflate(R.layout.navigation_impl_fragment, container, false);
