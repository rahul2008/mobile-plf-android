...
//
//        appInfra.getServiceDiscovery().getServiceLocaleWithCountryPreference(PRXFAQServiceID,
...
//                        appInfra.getServiceDiscovery().getServiceUrlWithCountryPreference(PRXFAQServiceID,
