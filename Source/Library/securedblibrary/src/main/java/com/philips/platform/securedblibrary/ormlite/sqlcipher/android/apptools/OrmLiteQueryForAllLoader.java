...
/**
 * A <code>Loader</code> implementation that queries specified {@link Dao} for all data, using the
 * <code>Dao.queryForAll()</code> call.
 * 
 * @author EgorAnd
 */
public class OrmLiteQueryForAllLoader<T, ID> extends com.j256.ormlite.android.apptools.BaseOrmLiteLoader<T, ID> {
