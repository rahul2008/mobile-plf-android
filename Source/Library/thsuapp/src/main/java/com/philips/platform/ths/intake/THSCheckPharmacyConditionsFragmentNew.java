...
public class THSCheckPharmacyConditionsFragmentNew extends THSBaseFragment implements THSCheckPharmacyConditonsView, LocationListener,
        GoogleApiClient.ConnectionCallbacks,
        GoogleApiClient.OnConnectionFailedListener {
    public static String TAG = THSCheckPharmacyConditionsFragmentNew.class.getSimpleName();
