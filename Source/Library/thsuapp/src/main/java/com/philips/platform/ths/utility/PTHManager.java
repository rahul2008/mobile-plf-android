...
import com.philips.platform.ths.intake.PTHConditions;
...
public class PTHManager {
    ...
    public void updateConditions(Context context, THSConsumer THSConsumer, List<PTHConditions> pthConditionList, final THSUpdateConditionsCallback thsUpdateConditionsCallback) throws AWSDKInstantiationException {
