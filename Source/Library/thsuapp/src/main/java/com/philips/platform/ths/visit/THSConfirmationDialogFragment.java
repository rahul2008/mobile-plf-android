...
public class THSConfirmationDialogFragment extends DialogFragment implements View.OnClickListener{
    ...
    public void setData(THSBasePresenter thsBasePresenter, String title, boolean isTitleIconVisible, String message, String primaryButtonText, String SecondaryButtonLabeltext){
        mPresenter=thsBasePresenter;
        if(!isTitleIconVisible) {
            mTitleImage.setVisibility(View.GONE);
        }
        mTitleLabel.setText(title);
        mMessageLabel.setText(message);
        mPrimaryButton.setText(primaryButtonText);
        mSecondaryButtonLabel.setText(SecondaryButtonLabeltext);
