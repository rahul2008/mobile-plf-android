...
public class DiskBasedCache implements Cache {
     ...
     * @param rootDirectory The root directory of the cache.
     */
    public DiskBasedCache(File rootDirectory, AppInfra appInfra) {
        this(rootDirectory, DEFAULT_DISK_USAGE_BYTES,appInfra);
    }
    ...
    public synchronized void put(String key, Entry entry) {
        ...
        if(sse.getErrorCode()!=null){
            ...
            try {
                ...
                fos.close();
                putEntry(key, e);
                mAppInfra.getAppInfraLogInstance().log(LoggingInterface.LogLevel.INFO, "AI Rest ", key + " response cached");
                return;
            } catch (IOException e) {
            }
