...
//        });
    ...
    String buildUrl() {
        ...
        if (identityManager.getSector() != null && identityManager.getMicrositeId() != null &&
            ...
            url = "https://" + environment + "/api/v1/discovery/" + identityManager.getSector() + "/" + identityManager.getMicrositeId() + "?locale=" + localManager.getUILocale().getLanguage() + "_" + localManager.getUILocale().getCountry() + "&tags=" + tags;
