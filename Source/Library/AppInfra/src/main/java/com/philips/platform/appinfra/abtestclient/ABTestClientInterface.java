...
public interface ABTestClientInterface {
     ...
     */
    enum CACHESTATUSVALUES {NO_TESTS_DEFINED, NO_CACHED_EXPERIENCES, EXPERIENCES_NOT_UPDATED,
        EXPERIENCES_PARTIALLY_UPDATED, EXPERIENCES_UPDATED};

    enum UPDATETYPES {UPDATE_ALWAYS ,EVERY_APP_START, ONLY_AT_APP_UPDATE};

    interface OnRefreshListener {
        enum ERRORVALUES {NO_NETWORK, SERVER_ERROR, EXPERIENCES_PARTIALLY_DOWNLOADED};
        void onSuccess();
