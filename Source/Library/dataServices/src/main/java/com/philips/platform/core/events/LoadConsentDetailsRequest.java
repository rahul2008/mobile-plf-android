 ...
 * All rights reserved.
 */
public class LoadConsentDetailsRequest extends Event {

    private final ConsentDetailType type;
    private ConsentDetailType[] types;

    public LoadConsentDetailsRequest() {
        types = null;
        type = null;
    }

    public LoadConsentDetailsRequest(final @NonNull ConsentDetailType... type) {
        this.type = type[0];
        this.types = type;
    }
