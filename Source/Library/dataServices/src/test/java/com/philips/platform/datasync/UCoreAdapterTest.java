...
/* when(icpClientFacadeMock.getUrl(IcpClientFacade.CQ5_SERVICE_TAG)).thenReturn(TEST_CQ5_URL);
    ...
    public void ShouldCreateClient_WhenGetClientIsCalled() throws Exception {
        ConsentsClient client = uCoreAdapter.getClient(CLIENT_CLASS,TEST_BASE_URL, ACCESS_TOKEN, gsonConverterMock);
    ...
    public void ShouldSetHeaders_WhenRequestIsIntercepted() throws Exception {
        uCoreAdapter.getClient(CLIENT_CLASS, ACCESS_TOKEN, gsonConverterMock);
    ...
    public void ShouldAddVersionAPIHeader_WhenRequestIsIntercepted() throws Exception {
        uCoreAdapter.getUGrowClient(CLIENT_CLASS, ACCESS_TOKEN, gsonConverterMock);
