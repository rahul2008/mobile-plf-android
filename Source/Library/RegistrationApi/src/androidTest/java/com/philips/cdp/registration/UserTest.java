...
public class UserTest extends ActivityInstrumentationTestCase2<RegistrationActivity> {
    ...
    private void saveToDisk(final String data) {
        SecureStorageInterface secureStorageInterface = new AppInfra.Builder().build(context).getSecureStorage();
        secureStorageInterface.storeValueForKey("jr_capture_signed_in_user", data);
    }
