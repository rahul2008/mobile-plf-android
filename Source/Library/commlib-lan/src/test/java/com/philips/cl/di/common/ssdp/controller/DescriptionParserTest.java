...
public class DescriptionParserTest extends RobolectricTest {
    ...
    @Test
    public void givenValidXML_shouldHaveDeviceList_whenParsing() throws Exception {
    ...
    @Test
    public void givenValidXML_shouldHaveNonEmptyDeviceList_whenParsing() throws Exception {
        parser.parse(CORRECT_XML_DESCRIPTION);
    ...
    @Test
    public void givenAlmostValidXML_shouldHaveDeviceList_whenParsing() throws Exception {
    ...
    @Test
    public void givenAlmostValidXML_shouldHaveEmptyDeviceList_whenParsing() throws Exception {
        parser.parse(ALMOST_CORRECT_XML_DESCRIPTION);
    ...
    @Test
    public void givenWrongXML_shouldHaveDeviceList_whenParsing() throws Exception {
    ...
    @Test
    public void givenWrongXML_shouldHaveEmptyDeviceList_whenParsing() throws Exception {
        parser.parse(WRONG_XML_DESCRIPTION);
