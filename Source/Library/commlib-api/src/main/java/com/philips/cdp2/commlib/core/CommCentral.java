...
public final class CommCentral {
     ...
     *
     * @param externalDependencies External dependencies for Commlib
     ...
     */
    public CommCentral(final @NonNull CommlibExternalDependencies externalDependencies, @NonNull ApplianceFactory applianceFactory, @NonNull final TransportContext... transportContexts) {
        this(externalDependencies, applianceFactory, null, transportContexts);
    }
     ...
     *                             provide {@link DiscoveryStrategy}s. You will need at least one!
     */
    public CommCentral(final @NonNull CommlibExternalDependencies externalDependencies, @NonNull ApplianceFactory applianceFactory, @Nullable ApplianceDatabase applianceDatabase, @NonNull final TransportContext... transportContexts) {
        ...
        for (TransportContext transportContext : transportContexts) {
            transportContext.setDependencies(externalDependencies);
