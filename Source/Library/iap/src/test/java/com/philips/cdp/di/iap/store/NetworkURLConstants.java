...
public class NetworkURLConstants {
    ...
    //Carts
    public static final String GET_CARTS_URL = BASE_URL + "/carts?fields=FULL&lang=en";
    public static final String DELETE_CART_URL = BASE_URL + "/carts/current";
    public static final String CREATE_CART_URL = BASE_URL + "/carts?fields=FULL&lang=en";
    public static final String ADD_TO_CART_URL = BASE_URL + "/carts/current/entries?fields=FULL&lang=en";
    ...
    public static final String CART_MODIFY_PRODUCT_URL = BASE_URL + "/carts/current/entries/" + DUMMY_PRODUCT_NUMBER + "?fields=FULL&lang=en";
    ...
    public static final String GET_ADDRESSES_URL = BASE_URL + "/addresses?fields=FULL&lang=en";
    public static final String EDIT_ADDRESS_URL = BASE_URL + "/addresses/" + DUMMY_PRODUCT_ID + "?fields=FULL&lang=en";
    public static final String GET_UPDATE_ADDRESS_URL = BASE_URL + "/addresses/" + ADDRESS_ID + "?fields=FULL&lang=en";
    public static final String SET_DELIVERY_ADDRESS_URL = BASE_URL + "/carts/current/addresses/delivery?fields=FULL&lang=en";

    //Delivery mode
    public static final String SET_DELIVERY_MODE_URL = BASE_URL + "/carts/current/deliverymode?fields=FULL&lang=en";
    public static final String GET_DELIVERY_MODES_URL = BASE_URL + "/carts/current/deliverymodes?fields=FULL&lang=en";

    //Payment
    public static final String SET_PAYMENT_DETAIL_URL = BASE_URL + "/carts/current/paymentdetails?fields=FULL&lang=en";
    public static final String GET_PAYMENT_DETAILS_URL = BASE_URL + "/paymentdetails?fields=FULL&lang=en";
    public static final String MAKE_PAYMENT_URL = BASE_URL + "/orders/" + DUMMY_PRODUCT_ID + "/pay?fields=FULL&lang=en";
    public static final String PLACE_ORDER_URL = BASE_URL + "/orders?fields=FULL&lang=en";

    //Orders
    public static final String ORDER_DETAIL_URL = BASE_URL + "/orders/" + DUMMY_ORDER_ID + "?fields=FULL&lang=en";
    public static final String ORDER_HISTORY_URL = BASE_URL + "/orders?fields=FULL&lang=en&currentPage=" + DUMMY_PAGE_NUMBER + "?fields=FULL&lang=en";
