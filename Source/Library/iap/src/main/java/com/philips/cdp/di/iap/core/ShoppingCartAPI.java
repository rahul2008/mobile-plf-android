...
public interface ShoppingCartAPI {
    ...
    void addProductToCart(Context context, String productCTN, IAPCartListener
            iapHandlerListener,
                          boolean isFromBuyNow);

    void getProductCartCount(Context context, IAPCartListener
            iapHandlerListener);

    void buyProduct(Context context, String ctnNumber, IAPCartListener
            iapHandlerListener);
