...
public class ApplianceAccessManager {
    ...
    public interface SetPropertiesCallback {
        void onPropertiesSet(@NonNull WifiPortProperties wifiPortProperties);//passing WifiPortProperties for future reference
            ...
            if (wifiPortProperties != null) {
                switch (requestType) {
                    ...
                    case ApplianceRequestType.PUT_WIFI_PROPS:
                        ...
                        if (putCallback != null) {
                            putCallback.onPropertiesSet(wifiPortProperties); //passing WifiPortProperties for future reference
                        }
                        break;
                    default:
