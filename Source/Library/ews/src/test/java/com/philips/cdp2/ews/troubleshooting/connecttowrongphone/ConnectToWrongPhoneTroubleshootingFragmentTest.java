...
public class ConnectToWrongPhoneTroubleshootingFragmentTest {
    ...
    private ConnectToWrongPhoneTroubleshootingFragment subject;

    @Before
    public void setUp() throws Exception {
        mockStatic(EWSTagger.class);
        subject = new ConnectToWrongPhoneTroubleshootingFragment();
    }

    @Test
    public void itShouldReturnCorrectPageNameForTagging() throws Exception {
        assertEquals("connectToWrongPhone", subject.getPageName());
    }
