...
public class SecondSetupStepsFragmentTest {

    private SecondSetupStepsFragment subject;

    @Before
    public void setUp() throws Exception {
        mockStatic(EWSTagger.class);
        subject = new SecondSetupStepsFragment();

    }

    @Test
    public void itShouldReturnCorrectPageNameForTagging() throws Exception {
        assertEquals("setupStep2", subject.getPageName());
    }
