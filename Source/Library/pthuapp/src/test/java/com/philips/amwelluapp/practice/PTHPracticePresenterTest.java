...
public class PTHPracticePresenterTest {
    ...
    private ArgumentCaptor<PTHPracticesListCallback> requestCaptor;
    ...
    public void setUp() {
        ...
        mUIBaseView = new PTHBaseFragment();
        mPTHPracticePresenter = new PTHPracticePresenter(mUIBaseView, mConsumer);
        assertNotNull(mPTHPracticePresenter);
   ...
   /* @Test
    public void fetchPracticeTestForNull()  {
        try {
            ...
            mMethod.invoke(mPTHPracticePresenter);
