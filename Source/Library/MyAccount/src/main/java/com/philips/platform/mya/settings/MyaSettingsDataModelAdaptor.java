...
class MyaSettingsDataModelAdaptor extends RecyclerView.Adapter<MyaSettingsDataModelAdaptor.SettingsViewHolder> {

    private LinkedHashMap<String, SettingsModel> settingsList;
    private View.OnClickListener onClickListener;

    MyaSettingsDataModelAdaptor(LinkedHashMap<String, SettingsModel> settingsList) {
