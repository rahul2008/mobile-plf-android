...
public class SecureDBMainActivity extends Activity implements OnClickListener {
    ...
    private <T> void updateAllRecords() {
        ...
        Log.i("SecureDBMainActivity", "updateRecordCount" + updateRecordCount);
    ...
    private void updateByWhere(int id) {
        ...
        Log.i("SecureDBMainActivity", "updateById" + updateRecordCount);
    ...
    private void openDialog(final String type) {
        LayoutInflater inflater = LayoutInflater.from(SecureDBMainActivity.this);
        ...
        builder.setNegativeButton("Cancel", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                Toast.makeText(SecureDBMainActivity.this, "Cancel", Toast.LENGTH_LONG).show();
            }
        });
