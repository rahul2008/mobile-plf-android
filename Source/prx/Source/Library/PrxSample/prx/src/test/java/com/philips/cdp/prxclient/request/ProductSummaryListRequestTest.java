 ...
 */
public class ProductSummaryListRequestTest {
    ...
    public void setUp() throws Exception {
        ...
        ctns.add("HX8331/01");
        ctns.add("HX8332/02");
        mProductDisclaimerBuilder = new ProductSummaryListRequest( ctns, null, null, null);

    }

    @Test
    public void testPrxBuilderObjectWithQueueParameter() {
        mProductDisclaimerBuilder = new ProductSummaryListRequest(ctns, null, null, "TAGINFO");
