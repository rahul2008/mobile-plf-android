package com.philips.platform.mya.demouapp.theme.themesettings;
...
public class NavigationController {
    ...
    private DemoAppActivity mainActivity;
    ...
    public NavigationController(final DemoAppActivity mainActivity, final Intent intent, final ViewDataBinding activityMainBinding) {
    ...
    private void clearLastFragmentOnFreshLaunch(Intent intent) {
        if (intent != null && !intent.hasExtra(DemoAppActivity.THEMESETTINGS_ACTIVITY_RESTART)) {
            storeFragmentInPreference(null);
        }
    }
    ...
    protected void showUiFromPreviousState(final Bundle savedInstanceState) {
        ...
        final int titleResourceId = savedInstanceState.getInt(DemoAppActivity.TITLE_TEXT, -1);
    ...
    public void onCreateOptionsMenu(final Menu menu, final DemoAppActivity mainActivity) {
    ...
    public void onSaveInstance(final Bundle outState) {
        ...
        outState.putInt(DemoAppActivity.TITLE_TEXT, titleResource);
    }
