...
public class ErrorMessageCreator {
    ...
    public static String getMessageErrorBasedOnErrorCode(Context context, int errorCode) {
        return errorCode == CONSENT_ERROR_AUTHENTICATION_FAILURE ? context.getString(R.string.csw_invalid_access_token_error_message) : context.getString(R.string.csw_generic_network_error);
    }
}
