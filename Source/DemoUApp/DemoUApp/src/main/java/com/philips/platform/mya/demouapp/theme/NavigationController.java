package com.philips.platform.mya.demouapp.theme;
...
import com.philips.platform.mya.demouapp.theme.themesettings.ThemeSettingsFragment;
...
public class NavigationController {
    ...
    private com.philips.platform.mya.demouapp.DemoAppActivity mainActivity;
    ...
    public NavigationController(final com.philips.platform.mya.demouapp.DemoAppActivity mainActivity, final Intent intent, final ViewDataBinding activityMainBinding) {
    ...
    private void clearLastFragmentOnFreshLaunch(Intent intent) {
        if (intent != null && !intent.hasExtra(com.philips.platform.mya.demouapp.DemoAppActivity.THEMESETTINGS_ACTIVITY_RESTART)) {
            storeFragmentInPreference(null);
        }
    }
    ...
    protected void showUiFromPreviousState(final Bundle savedInstanceState) {
        ...
        final int titleResourceId = savedInstanceState.getInt(com.philips.platform.mya.demouapp.DemoAppActivity.TITLE_TEXT, -1);
    ...
    private void showHamburgerIcon() {
      //  toolbar.setNavigationIcon(VectorDrawableCompat.create(mainActivity.getResources(), R.drawable.ic_hamburger_icon, mainActivity.getTheme()));
        ...
        setTitleText(R.string.my_account_demo);
        titleResource = R.string.my_account_demo;
    }
    ...
    public void onCreateOptionsMenu(final Menu menu, final com.philips.platform.mya.demouapp.DemoAppActivity mainActivity) {
    ...
    public void onSaveInstance(final Bundle outState) {
        ...
        outState.putInt(com.philips.platform.mya.demouapp.DemoAppActivity.TITLE_TEXT, titleResource);
    }
