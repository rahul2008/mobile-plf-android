...
import static com.philips.cdp2.commlib.demouapp.R.layout.cml_fragment_persistance;
...
public class PersistApplianceFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        final View rootView = inflater.inflate(cml_fragment_persistance, container, false);
