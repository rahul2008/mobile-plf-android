...
public class LanRequestTest {
    ...
    public void setUp() throws Exception {
        ...
        lanRequest = new LanRequest(networkNodeMock, connectivityMonitorMock, null, "portname", 0, LanRequestType.GET, null, null, null) {
            @NonNull
            @Override
    ...
    public void givenARequestIsCreated_whenNetworkNodeIsNotMarkedSecure_thenTheUrlProtocolShouldBeHttp() {
        ...
        LanRequest lanRequest = new LanRequest(networkNodeMock, connectivityMonitorMock, null, "portname", 0, LanRequestType.GET, null, null, null);
    ...
    public void givenADeleteRequestIsExecuted_whenDataMapIsNull_thenRequestCompletesWithoutException() throws Exception {
        ...
        lanRequest = new LanRequest(networkNodeMock, connectivityMonitorMock, null, "portname", 0, LanRequestType.DELETE, null, null, null) {
            @NonNull
            @Override
            HttpURLConnection createConnection(@NonNull URL url, @NonNull String requestMethod) throws IOException, TransportUnavailableException {
                return connectionMock;
