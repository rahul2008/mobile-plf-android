...
public class NonSecureNetworkNodeDatabaseHelperVersion3Test extends NonSecureNetworkNodeDatabaseHelperBaseTest {
    ...
    static String VERSION_3_CREATE_QUERY = "CREATE TABLE IF NOT EXISTS network_node("
    ...
    @Test
    public void whenDatabaseIsCreatedOfVersion3_thenAllColumnsAreCreated() {
        prepareSqliteDatabase(VERSION_3, VERSION_3_CREATE_QUERY);
    ...
    @Test
    public void givenVersionIs1_whenUpgradingToVersion3_ThenDataShouldBeCorrect_bootId() {
        final SQLiteDatabase database = prepareSqliteDatabase(VERSION_1, VERSION_1_CREATE_QUERY);
        ContentValues data = createContentValues(VERSION_1);
        database.insertWithOnConflict(TABLE_NETWORK_NODE, null, data, SQLiteDatabase.CONFLICT_REPLACE);
    ...
    @Test
    public void givenVersionIs1_whenUpgradingToVersion3_ThenDataShouldBeCorrect_encryptionKey() {
        final SQLiteDatabase database = prepareSqliteDatabase(VERSION_1, VERSION_1_CREATE_QUERY);
        ContentValues data = createContentValues(VERSION_1);
        database.insertWithOnConflict(TABLE_NETWORK_NODE, null, data, SQLiteDatabase.CONFLICT_REPLACE);
    ...
    @Test
    public void givenVersionIs1_whenUpgradingToVersion3_ThenDataShouldBeCorrect_name() {
        final SQLiteDatabase database = prepareSqliteDatabase(VERSION_1, VERSION_1_CREATE_QUERY);
        ContentValues data = createContentValues(VERSION_1);
        database.insertWithOnConflict(TABLE_NETWORK_NODE, null, data, SQLiteDatabase.CONFLICT_REPLACE);
    ...
    @Test
    public void givenVersionIs1_whenUpgradingToVersion3_ThenDataShouldBeCorrect_lastKnownNetwork() {
        final SQLiteDatabase database = prepareSqliteDatabase(VERSION_1, VERSION_1_CREATE_QUERY);
        ContentValues data = createContentValues(VERSION_1);
        database.insertWithOnConflict(TABLE_NETWORK_NODE, null, data, SQLiteDatabase.CONFLICT_REPLACE);
    ...
    @Test
    public void givenVersionIs1_whenUpgradingToVersion3_ThenDataShouldBeCorrect_isPaired() {
        final SQLiteDatabase database = prepareSqliteDatabase(VERSION_1, VERSION_1_CREATE_QUERY);
        ContentValues data = createContentValues(VERSION_1);
        database.insertWithOnConflict(TABLE_NETWORK_NODE, null, data, SQLiteDatabase.CONFLICT_REPLACE);
    ...
    @Test
    public void givenVersionIs1_whenUpgradingToVersion3_ThenDataShouldBeCorrect_lastPairedTime() {
        final SQLiteDatabase database = prepareSqliteDatabase(VERSION_1, VERSION_1_CREATE_QUERY);
        ContentValues data = createContentValues(VERSION_1);
        database.insertWithOnConflict(TABLE_NETWORK_NODE, null, data, SQLiteDatabase.CONFLICT_REPLACE);
    ...
    @Test
    public void givenVersionIs1_whenUpgradingToVersion3_ThenDataShouldBeCorrect_ipAddress() {
        final SQLiteDatabase database = prepareSqliteDatabase(VERSION_1, VERSION_1_CREATE_QUERY);
        ContentValues data = createContentValues(VERSION_1);
        database.insertWithOnConflict(TABLE_NETWORK_NODE, null, data, SQLiteDatabase.CONFLICT_REPLACE);
    ...
    @Test
    public void givenVersionIs1_whenUpgradingToVersion3_ThenDataShouldBeCorrect_https() {
        final SQLiteDatabase database = prepareSqliteDatabase(VERSION_1, VERSION_1_CREATE_QUERY);
        ContentValues data = createContentValues(VERSION_1);
        database.insertWithOnConflict(TABLE_NETWORK_NODE, null, data, SQLiteDatabase.CONFLICT_REPLACE);
    ...
    @Test
    public void givenVersionIs2_whenUpgradingToVersion3_ThenDataShouldBeCorrect_https() {
    ...
    @Test
    public void givenVersionIs1_whenUpgradingToVersion3_ThenDataShouldBeCorrect_modelId() {
        final SQLiteDatabase database = prepareSqliteDatabase(VERSION_1, VERSION_1_CREATE_QUERY);
        ContentValues data = createContentValues(VERSION_1);
        database.insertWithOnConflict(TABLE_NETWORK_NODE, null, data, SQLiteDatabase.CONFLICT_REPLACE);
    ...
    @Test
    public void givenVersionIs2_whenUpgradingToVersion3_ThenDataShouldBeCorrect_modelId() {
        final SQLiteDatabase database = prepareSqliteDatabase(VERSION_2, VERSION_2_CREATE_QUERY);
        ContentValues data = createContentValues(VERSION_2);
        database.insertWithOnConflict(TABLE_NETWORK_NODE, null, data, SQLiteDatabase.CONFLICT_REPLACE);
