...
public class NonSecureNetworkNodeDatabaseHelperVersion5Test extends NonSecureNetworkNodeDatabaseHelperBaseTest {
    ...
    static String VERSION_5_CREATE_QUERY = "CREATE TABLE IF NOT EXISTS network_node("
    ...
    @Test
    public void whenDatabaseIsCreatedOfVersion5_thenAllColumnsAreCreated() {
        prepareSqliteDatabase(VERSION_5, VERSION_5_CREATE_QUERY);
    ...
    @Test
    public void givenVersionIs1_whenUpgradingToVersion5_ThenDataShouldBeCorrect_bootId() {
        final SQLiteDatabase database = prepareSqliteDatabase(VERSION_1, VERSION_1_CREATE_QUERY);
        ContentValues data = createContentValues(VERSION_1);
        database.insertWithOnConflict(TABLE_NETWORK_NODE, null, data, SQLiteDatabase.CONFLICT_REPLACE);
    ...
    @Test
    public void givenVersionIs1_whenUpgradingToVersion5_ThenDataShouldBeCorrect_encryptionKey() {
        final SQLiteDatabase database = prepareSqliteDatabase(VERSION_1, VERSION_1_CREATE_QUERY);
        ContentValues data = createContentValues(VERSION_1);
        database.insertWithOnConflict(TABLE_NETWORK_NODE, null, data, SQLiteDatabase.CONFLICT_REPLACE);
    ...
    @Test
    public void givenVersionIs1_whenUpgradingToVersion5_ThenDataShouldBeCorrect_name() {
        final SQLiteDatabase database = prepareSqliteDatabase(VERSION_1, VERSION_1_CREATE_QUERY);
        ContentValues data = createContentValues(VERSION_1);
        database.insertWithOnConflict(TABLE_NETWORK_NODE, null, data, SQLiteDatabase.CONFLICT_REPLACE);
    ...
    @Test
    public void givenVersionIs1_whenUpgradingToVersion5_ThenDataShouldBeCorrect_lastKnownNetwork() {
        final SQLiteDatabase database = prepareSqliteDatabase(VERSION_1, VERSION_1_CREATE_QUERY);
        ContentValues data = createContentValues(VERSION_1);
        database.insertWithOnConflict(TABLE_NETWORK_NODE, null, data, SQLiteDatabase.CONFLICT_REPLACE);
    ...
    @Test
    public void givenVersionIs1_whenUpgradingToVersion5_ThenDataShouldBeCorrect_isPaired() {
        final SQLiteDatabase database = prepareSqliteDatabase(VERSION_1, VERSION_1_CREATE_QUERY);
        ContentValues data = createContentValues(VERSION_1);
        database.insertWithOnConflict(TABLE_NETWORK_NODE, null, data, SQLiteDatabase.CONFLICT_REPLACE);
    ...
    @Test
    public void givenVersionIs1_whenUpgradingToVersion5_ThenDataShouldBeCorrect_lastPairedTime() {
        final SQLiteDatabase database = prepareSqliteDatabase(VERSION_1, VERSION_1_CREATE_QUERY);
        ContentValues data = createContentValues(VERSION_1);
        database.insertWithOnConflict(TABLE_NETWORK_NODE, null, data, SQLiteDatabase.CONFLICT_REPLACE);
    ...
    @Test
    public void givenVersionIs1_whenUpgradingToVersion5_ThenDataShouldBeCorrect_ipAddress() {
        final SQLiteDatabase database = prepareSqliteDatabase(VERSION_1, VERSION_1_CREATE_QUERY);
        ContentValues data = createContentValues(VERSION_1);
        database.insertWithOnConflict(TABLE_NETWORK_NODE, null, data, SQLiteDatabase.CONFLICT_REPLACE);
    ...
    @Test
    public void givenVersionIs1_whenUpgradingToVersion5_ThenDataShouldBeCorrect_https() {
        final SQLiteDatabase database = prepareSqliteDatabase(VERSION_1, VERSION_1_CREATE_QUERY);
        ContentValues data = createContentValues(VERSION_1);
        database.insertWithOnConflict(TABLE_NETWORK_NODE, null, data, SQLiteDatabase.CONFLICT_REPLACE);
    ...
    @Test
    public void givenVersionIs2_whenUpgradingToVersion5_ThenDataShouldBeCorrect_https() {
    ...
    @Test
    public void givenVersionIs1_whenUpgradingToVersion5_ThenDataShouldBeCorrect_modelId() {
        final SQLiteDatabase database = prepareSqliteDatabase(VERSION_1, VERSION_1_CREATE_QUERY);
        ContentValues data = createContentValues(VERSION_1);
        database.insertWithOnConflict(TABLE_NETWORK_NODE, null, data, SQLiteDatabase.CONFLICT_REPLACE);
    ...
    @Test
    public void givenVersionIs2_whenUpgradingToVersion5_ThenDataShouldBeCorrect_modelId() {
        final SQLiteDatabase database = prepareSqliteDatabase(VERSION_2, VERSION_2_CREATE_QUERY);
        ContentValues data = createContentValues(VERSION_2);
        database.insertWithOnConflict(TABLE_NETWORK_NODE, null, data, SQLiteDatabase.CONFLICT_REPLACE);
    ...
    @Test
    public void givenVersionIs1_whenUpgradingToVersion5_ThenPinShouldHaveDefaultValue() {
        final SQLiteDatabase database = prepareSqliteDatabase(VERSION_1, VERSION_1_CREATE_QUERY);
        ContentValues data = createContentValues(VERSION_1);
        database.insertWithOnConflict(TABLE_NETWORK_NODE, null, data, SQLiteDatabase.CONFLICT_REPLACE);
    ...
    @Test
    public void givenVersionIs2_whenUpgradingToVersion5_ThenPinShouldHaveDefaultValue() {
        final SQLiteDatabase database = prepareSqliteDatabase(VERSION_2, VERSION_2_CREATE_QUERY);
        ContentValues data = createContentValues(VERSION_2);
        database.insertWithOnConflict(TABLE_NETWORK_NODE, null, data, SQLiteDatabase.CONFLICT_REPLACE);
    ...
    @Test
    public void givenVersionIs3_whenUpgradingToVersion5_ThenPinShouldHaveDefaultValue() {
    ...
    @Test
    public void givenVersionIs4_whenUpgradingToVersion5_ThenPinShouldHaveDefaultValue() {
    ...
    @Test
    public void givenVersionIs1_whenUpgradingToVersion5_ThenDeviceTypeShouldBePresent() {
        final SQLiteDatabase database = prepareSqliteDatabase(VERSION_1, VERSION_1_CREATE_QUERY);
        ContentValues data = createContentValues(VERSION_1);
        database.insertWithOnConflict(TABLE_NETWORK_NODE, null, data, SQLiteDatabase.CONFLICT_REPLACE);
    ...
    @Test
    public void givenVersionIs2_whenUpgradingToVersion5_ThenDeviceTypeShouldBePresent() {
        final SQLiteDatabase database = prepareSqliteDatabase(VERSION_2, VERSION_2_CREATE_QUERY);
        ContentValues data = createContentValues(VERSION_2);
        database.insertWithOnConflict(TABLE_NETWORK_NODE, null, data, SQLiteDatabase.CONFLICT_REPLACE);
    ...
    @Test
    public void givenVersionIs3_whenUpgradingToVersion5_ThenDeviceTypeShouldBePresent() {
        final SQLiteDatabase database = prepareSqliteDatabase(VERSION_3, VERSION_3_CREATE_QUERY);
        ContentValues data = createContentValues(VERSION_3);
        database.insertWithOnConflict(TABLE_NETWORK_NODE, null, data, SQLiteDatabase.CONFLICT_REPLACE);
    ...
    @Test
    public void givenVersionIs4_whenUpgradingToVersion5_ThenDeviceTypeShouldBePresent() {
        final SQLiteDatabase database = prepareSqliteDatabase(VERSION_4, VERSION_4_CREATE_QUERY);
        ContentValues data = createContentValues(VERSION_4);
        database.insertWithOnConflict(TABLE_NETWORK_NODE, null, data, SQLiteDatabase.CONFLICT_REPLACE);
    ...
    @Test
    public void givenVersionIs5_whenStoringDeviceType_ThenDeviceTypeShouldBePresent() {
