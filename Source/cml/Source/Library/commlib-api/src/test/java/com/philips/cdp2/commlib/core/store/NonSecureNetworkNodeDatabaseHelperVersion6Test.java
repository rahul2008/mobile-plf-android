...
public class NonSecureNetworkNodeDatabaseHelperVersion6Test extends NonSecureNetworkNodeDatabaseHelperBaseTest {
    ...
    static String VERSION_6_CREATE_QUERY = "CREATE TABLE IF NOT EXISTS network_node("
    ...
    public void whenDatabaseIsCreatedOfVersion6_thenAllColumnsAreCreated() {
        prepareSqliteDatabase(VERSION_6, VERSION_6_CREATE_QUERY);
    ...
    @Test
    public void givenVersionIs1_whenUpgradingToVersion6_ThenDataShouldBeCorrect_bootId() {
        final SQLiteDatabase database = prepareSqliteDatabase(VERSION_1, VERSION_1_CREATE_QUERY);
        ContentValues data = createContentValues(VERSION_1);
        database.insertWithOnConflict(TABLE_NETWORK_NODE, null, data, SQLiteDatabase.CONFLICT_REPLACE);
    ...
    @Test
    public void givenVersionIs1_whenUpgradingToVersion6_ThenDataShouldBeCorrect_encryptionKey() {
        final SQLiteDatabase database = prepareSqliteDatabase(VERSION_1, VERSION_1_CREATE_QUERY);
        ContentValues data = createContentValues(VERSION_1);
        database.insertWithOnConflict(TABLE_NETWORK_NODE, null, data, SQLiteDatabase.CONFLICT_REPLACE);
    ...
    @Test
    public void givenVersionIs1_whenUpgradingToVersion6_ThenDataShouldBeCorrect_name() {
        final SQLiteDatabase database = prepareSqliteDatabase(VERSION_1, VERSION_1_CREATE_QUERY);
        ContentValues data = createContentValues(VERSION_1);
        database.insertWithOnConflict(TABLE_NETWORK_NODE, null, data, SQLiteDatabase.CONFLICT_REPLACE);
    ...
    @Test
    public void givenVersionIs1_whenUpgradingToVersion6_ThenDataShouldBeCorrect_lastKnownNetwork() {
        final SQLiteDatabase database = prepareSqliteDatabase(VERSION_1, VERSION_1_CREATE_QUERY);
        ContentValues data = createContentValues(VERSION_1);
        database.insertWithOnConflict(TABLE_NETWORK_NODE, null, data, SQLiteDatabase.CONFLICT_REPLACE);
    ...
    @Test
    public void givenVersionIs1_whenUpgradingToVersion6_ThenDataShouldBeCorrect_isPaired() {
        final SQLiteDatabase database = prepareSqliteDatabase(VERSION_1, VERSION_1_CREATE_QUERY);
        ContentValues data = createContentValues(VERSION_1);
        database.insertWithOnConflict(TABLE_NETWORK_NODE, null, data, SQLiteDatabase.CONFLICT_REPLACE);
    ...
    @Test
    public void givenVersionIs1_whenUpgradingToVersion6_ThenDataShouldBeCorrect_lastPairedTime() {
        final SQLiteDatabase database = prepareSqliteDatabase(VERSION_1, VERSION_1_CREATE_QUERY);
        ContentValues data = createContentValues(VERSION_1);
        database.insertWithOnConflict(TABLE_NETWORK_NODE, null, data, SQLiteDatabase.CONFLICT_REPLACE);
    ...
    @Test
    public void givenVersionIs1_whenUpgradingToVersion6_ThenDataShouldBeCorrect_ipAddress() {
        final SQLiteDatabase database = prepareSqliteDatabase(VERSION_1, VERSION_1_CREATE_QUERY);
        ContentValues data = createContentValues(VERSION_1);
        database.insertWithOnConflict(TABLE_NETWORK_NODE, null, data, SQLiteDatabase.CONFLICT_REPLACE);
    ...
    @Test
    public void givenVersionIs1_whenUpgradingToVersion6_ThenDataShouldBeCorrect_https() {
        final SQLiteDatabase database = prepareSqliteDatabase(VERSION_1, VERSION_1_CREATE_QUERY);
        ContentValues data = createContentValues(VERSION_1);
        database.insertWithOnConflict(TABLE_NETWORK_NODE, null, data, SQLiteDatabase.CONFLICT_REPLACE);
    ...
    @Test
    public void givenVersionIs2_whenUpgradingToVersion6_ThenDataShouldBeCorrect_https() {
        final SQLiteDatabase database = prepareSqliteDatabase(VERSION_2, VERSION_2_CREATE_QUERY);
    ...
    @Test
    public void givenVersionIs1_whenUpgradingToVersion6_ThenDataShouldBeCorrect_modelId() {
        final SQLiteDatabase database = prepareSqliteDatabase(VERSION_1, VERSION_1_CREATE_QUERY);
        ContentValues data = createContentValues(VERSION_1);
        database.insertWithOnConflict(TABLE_NETWORK_NODE, null, data, SQLiteDatabase.CONFLICT_REPLACE);
    ...
    @Test
    public void givenVersionIs2_whenUpgradingToVersion6_ThenDataShouldBeCorrect_modelId() {
        final SQLiteDatabase database = prepareSqliteDatabase(VERSION_2, VERSION_2_CREATE_QUERY);
        ContentValues data = createContentValues(VERSION_2);
        database.insertWithOnConflict(TABLE_NETWORK_NODE, null, data, SQLiteDatabase.CONFLICT_REPLACE);
    ...
    @Test
    public void givenVersionIs1_whenUpgradingToVersion6_ThenPinShouldHaveDefaultValue() {
        final SQLiteDatabase database = prepareSqliteDatabase(VERSION_1, VERSION_1_CREATE_QUERY);
        ContentValues data = createContentValues(VERSION_1);
        database.insertWithOnConflict(TABLE_NETWORK_NODE, null, data, SQLiteDatabase.CONFLICT_REPLACE);
    ...
    @Test
    public void givenVersionIs2_whenUpgradingToVersion6_ThenPinShouldHaveDefaultValue() {
        final SQLiteDatabase database = prepareSqliteDatabase(VERSION_2, VERSION_2_CREATE_QUERY);
        ContentValues data = createContentValues(VERSION_2);
        database.insertWithOnConflict(TABLE_NETWORK_NODE, null, data, SQLiteDatabase.CONFLICT_REPLACE);
    ...
    @Test
    public void givenVersionIs3_whenUpgradingToVersion6_ThenPinShouldHaveDefaultValue() {
        final SQLiteDatabase database = prepareSqliteDatabase(VERSION_3, VERSION_3_CREATE_QUERY);
    ...
    @Test
    public void givenVersionIs4_whenUpgradingToVersion6_ThenPinShouldHaveDefaultValue() {
        final SQLiteDatabase database = prepareSqliteDatabase(VERSION_4, VERSION_4_CREATE_QUERY);
    ...
    @Test
    public void givenVersionIs1_whenUpgradingToVersion6_ThenDeviceTypeShouldBePresent() {
        final SQLiteDatabase database = prepareSqliteDatabase(VERSION_1, VERSION_1_CREATE_QUERY);
        ContentValues data = createContentValues(VERSION_1);
        database.insertWithOnConflict(TABLE_NETWORK_NODE, null, data, SQLiteDatabase.CONFLICT_REPLACE);
    ...
    @Test
    public void givenVersionIs2_whenUpgradingToVersion6_ThenDeviceTypeShouldBePresent() {
        final SQLiteDatabase database = prepareSqliteDatabase(VERSION_2, VERSION_2_CREATE_QUERY);
        ContentValues data = createContentValues(VERSION_2);
        database.insertWithOnConflict(TABLE_NETWORK_NODE, null, data, SQLiteDatabase.CONFLICT_REPLACE);
    ...
    @Test
    public void givenVersionIs3_whenUpgradingToVersion6_ThenDeviceTypeShouldBePresent() {
        final SQLiteDatabase database = prepareSqliteDatabase(VERSION_3, VERSION_3_CREATE_QUERY);
        ContentValues data = createContentValues(VERSION_3);
        database.insertWithOnConflict(TABLE_NETWORK_NODE, null, data, SQLiteDatabase.CONFLICT_REPLACE);
    ...
    @Test
    public void givenVersionIs4_whenUpgradingToVersion6_ThenDeviceTypeShouldBePresent() {
        final SQLiteDatabase database = prepareSqliteDatabase(VERSION_4, VERSION_4_CREATE_QUERY);
        ContentValues data = createContentValues(VERSION_4);
        database.insertWithOnConflict(TABLE_NETWORK_NODE, null, data, SQLiteDatabase.CONFLICT_REPLACE);
    ...
    @Test
    public void givenVersionIs1_whenUpgradingToVersion6_ThenMismatchedPinShouldHaveDefaultValue() {
        final SQLiteDatabase database = prepareSqliteDatabase(VERSION_1, VERSION_1_CREATE_QUERY);
        ContentValues data = createContentValues(VERSION_1);
        database.insertWithOnConflict(TABLE_NETWORK_NODE, null, data, SQLiteDatabase.CONFLICT_REPLACE);
    ...
    @Test
    public void givenVersionIs2_whenUpgradingToVersion6_ThenMismatchedPinShouldHaveDefaultValue() {
        final SQLiteDatabase database = prepareSqliteDatabase(VERSION_2, VERSION_2_CREATE_QUERY);
        ContentValues data = createContentValues(VERSION_2);
        database.insertWithOnConflict(TABLE_NETWORK_NODE, null, data, SQLiteDatabase.CONFLICT_REPLACE);
    ...
    @Test
    public void givenVersionIs3_whenUpgradingToVersion6_ThenMismatchedPinShouldHaveDefaultValue() {
        final SQLiteDatabase database = prepareSqliteDatabase(VERSION_3, VERSION_3_CREATE_QUERY);
        ContentValues data = createContentValues(VERSION_3);
        database.insertWithOnConflict(TABLE_NETWORK_NODE, null, data, SQLiteDatabase.CONFLICT_REPLACE);
    ...
    @Test
    public void givenVersionIs4_whenUpgradingToVersion6_ThenMismatchedPinShouldHaveDefaultValue() {
        final SQLiteDatabase database = prepareSqliteDatabase(VERSION_4, VERSION_4_CREATE_QUERY);
        ContentValues data = createContentValues(VERSION_4);
        database.insertWithOnConflict(TABLE_NETWORK_NODE, null, data, SQLiteDatabase.CONFLICT_REPLACE);
    ...
    @Test
    public void givenVersionIs5_whenUpgradingToVersion6_ThenMismatchedPinShouldHaveDefaultValue() {
        final SQLiteDatabase database = prepareSqliteDatabase(VERSION_5, VERSION_5_CREATE_QUERY);
    ...
    public void givenVersionIs6_whenStoringMismatchedPin_ThenDataHasCorrectMismatchedPin() {
        ...
        Cursor cursor = getReadableDatabaseCursor();
        String pin = cursor.getString(cursor.getColumnIndex(KEY_MISMATCHED_PIN));
        assertEquals(MISMATCHED_PIN, pin);
