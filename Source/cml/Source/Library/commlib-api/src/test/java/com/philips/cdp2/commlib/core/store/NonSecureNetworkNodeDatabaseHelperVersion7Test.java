...
public class NonSecureNetworkNodeDatabaseHelperVersion7Test extends NonSecureNetworkNodeDatabaseHelperBaseTest {
    ...
    public void givenVersionIs1_whenUpgradingToVersion7_thenDatabaseStructureShouldBeCorrect() {
    ...
    @Test
    public void givenVersionIs2_whenUpgradingToVersion7_thenDatabaseStructureShouldBeCorrect() {
    ...
    @Test
    public void givenVersionIs3_whenUpgradingToVersion7_thenDatabaseStructureShouldBeCorrect() {
    ...
    @Test
    public void givenVersionIs4_whenUpgradingToVersion7_thenDatabaseStructureShouldBeCorrect() {
    ...
    @Test
    public void givenVersionIs5_whenUpgradingToVersion7_thenDatabaseStructureShouldBeCorrect() {
    ...
    @Test
    public void givenVersionIs6_whenUpgradingToVersion7_thenDatabaseStructureShouldBeCorrect() {
