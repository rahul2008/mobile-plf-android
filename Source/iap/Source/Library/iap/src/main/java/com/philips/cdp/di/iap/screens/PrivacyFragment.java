 ...
 */
public class PrivacyFragment extends InAppBaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ViewGroup group = (ViewGroup) inflater.inflate(R.layout.fragment_privacy, container, false);
    ...
    public void onResume() {
        super.onResume();
        String title = "Notice of Privacy";
    ...
    public static PrivacyFragment createInstance(Bundle args, AnimationType animType) {
    ...
    void initializeWebView(View group) {
        mWebView = (WebView) group.findViewById(R.id.wv_privacy);
