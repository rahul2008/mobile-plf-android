...
public class CircularButtonRegularTest {
    ...
    public void verifyCircularButtonRegularWidth() {
        int expectedWidth = resources.getDimensionPixelSize(R.dimen.circular_button_regular_height_width);
    ...
    public void verifyCircularButtonRegularHeight() {
        int expectedHeight = resources.getDimensionPixelSize(R.dimen.circular_button_regular_height_width);
    ...
    private ViewInteraction getButton() {
        return onView(withId(com.philips.platform.uid.test.R.id.circularImageButtonRegular));
    }

    private boolean isAccentButton(){
        Button button = (Button) activity.findViewById(com.philips.platform.uid.test.R.id.circularImageButtonRegular);
        if(button != null)
