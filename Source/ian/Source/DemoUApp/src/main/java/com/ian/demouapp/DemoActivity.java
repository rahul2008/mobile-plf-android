...
public class DemoActivity extends AppCompatActivity implements View.OnClickListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        urInterface.init(new IanDemoUAppDependencies(new AppInfra.Builder().build(getApplicationContext())), new IanDemoAppSettings(getApplicationContext()));
        ...
        String propertyForKey = (String) configInterface.getPropertyForKey("propositionid", "IAN", configError);
        ...
        mBtnSetPropositionId.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                configInterface.setPropertyForKey("propositionid", "IAN", mEtPropositionId.getText().toString(), configError);
    ...
    private void initializeIANComponant() {
    ...
    private void displayFlowViews(boolean b) {
       ...
       // mIapInterface.getProductCartCount(this);
        ...
        if (b) {
            ...
            mCountText.setVisibility(View.VISIBLE);
            mShoppingCart.setVisibility(View.VISIBLE);
            //mIanInterface.getProductCartCount(this);
        } else {
            mCartIcon.setVisibility(View.GONE);
            mCountText.setVisibility(View.GONE);
            mShoppingCart.setVisibility(View.GONE);
    ...
    private void actionBar() {
        ...
        setTitle(getString(R.string.ian_app_name));
        mShoppingCart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //if (isClickable())
                    //launchIAN(IANLaunchInput.IAPFlows.IAP_SHOPPING_CART_VIEW, null, null);
            }
        });
    }
