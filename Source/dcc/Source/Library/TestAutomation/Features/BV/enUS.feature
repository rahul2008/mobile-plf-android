Feature:Submitting the product review with EN-US combination
@enUS
Scenario:To submit the product review by changing the language to English and country to US
...
Then I select "United States(US)" from "spinner2"
Then I touch the ctn 
Then I enter text into product text
