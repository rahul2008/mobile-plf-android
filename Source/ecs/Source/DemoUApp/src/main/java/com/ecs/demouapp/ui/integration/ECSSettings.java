 ...
 * @since 1.0.0
 */
public class ECSSettings extends UappSettings {
    ...
    private ECSMockInterface iapMockInterface;
     ...
     * @since 1.0.0
     */
    public ECSSettings(Context applicationContext) {
    ...
    public ECSMockInterface getIapMockInterface() {
        return iapMockInterface;
    }

    public void setIapMockInterface(ECSMockInterface iapMockInterface) {
