...
class MockGetOrderDetailRequest(jsonFileName:String,orderID: String, ecsCallback: ECSCallback<ECSOrderDetail, Exception>) : GetOrderDetailRequest(orderID, ecsCallback) {
