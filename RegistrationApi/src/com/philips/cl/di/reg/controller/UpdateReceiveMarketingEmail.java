...
public class UpdateReceiveMarketingEmail implements CaptureApiRequestCallback {
	...
	public UpdateReceiveMarketingEmail(UpdateReceiveMarketingEmailHandler updateReceiveMarketingEmailHandler,Context context,boolean receiveMarketingEmail) {
	...
	public void onFailure(CaptureApiError error) {
       ...
       mUpdateReceiveMarketingEmailHandler.onUpdateReceiveMarketingEmailFailedWithError(getError);
	}
}
