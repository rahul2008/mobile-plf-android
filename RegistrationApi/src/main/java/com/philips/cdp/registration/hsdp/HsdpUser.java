...
public class HsdpUser {
    ...
    private DhpApiClientConfiguration getDhpApiClientConfiguration() {
        DhpApiClientConfiguration dhpApiClientConfiguration;
        dhpApiClientConfiguration = new DhpApiClientConfiguration(
                RegistrationConfiguration.getInstance().getHsdpConfiguration().getDevelopmentIds().getBaseURL(),
                RegistrationConfiguration.getInstance().getHsdpConfiguration().getApplicationName(),
                RegistrationConfiguration.getInstance().getHsdpConfiguration().getDevelopmentIds().getSharedKey(),
                RegistrationConfiguration.getInstance().getHsdpConfiguration().getDevelopmentIds().getSecretKey());
