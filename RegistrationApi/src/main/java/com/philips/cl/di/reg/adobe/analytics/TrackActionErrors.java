...
public class TrackActionErrors {
	...
	private static final String INVALID_INPUT_FIELDS = "incorrect email or password"; //invalid input fields

	private static final String EMAIL_IS_NOT_VERIFIED = "email is not verified";

	private static final String WE_RE_HAVING_TROUBLE_LOGINING_USER = "network error";//we're having trouble logging user

	private static final String WE_RE_HAVING_TROUBLE_REGISTRING_USER = "network error"; //we're having trouble registering user
