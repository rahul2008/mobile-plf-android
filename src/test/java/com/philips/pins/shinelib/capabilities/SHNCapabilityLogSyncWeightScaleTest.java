...
public class SHNCapabilityLogSyncWeightScaleTest {
    ...
    public void setUp() {
        ...
        timeoutRunnableCaptor = ArgumentCaptor.forClass(Runnable.class);
        when(Timer.createTimer(timeoutRunnableCaptor.capture(), anyLong())).thenReturn(mockedTimeoutTimer);
