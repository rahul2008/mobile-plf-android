 ...
 */
public class SHNServiceCurrentTime implements SHNService.SHNServiceListener {
    ...
    public static final UUID LOCAL_TIME_CHARACTERISTIC_UUID =           UUID.fromString(BleUUIDCreator.create128bitBleUUIDFrom16BitBleUUID(0x2A0F));
    ...
    private Set<UUID> getOptionalCharacteristics() {
        Set<UUID> uuids = new HashSet<>();
        uuids.add(LOCAL_TIME_CHARACTERISTIC_UUID);
