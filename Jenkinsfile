                    ...
                    stage('publishing leakcanaryapps') {
                        ...
                        def shellcommand = '''#!/bin/bash -l
                            ...
                            then
                                ...
                                echo "$ARTIFACTORY_URL/$ARTIFACTORY_REPO/com/philips/cdp/referenceApp/LeakCanary/$APK_NAME" > $BASE_PATH/Source/AppFramework/apkname.txt
                            fi
