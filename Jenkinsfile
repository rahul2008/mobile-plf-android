    ...
    timestamps {
        try {
            ...
            stage ('reporting and archiving') {
                ...
                publishHTML([allowMissing: false, alwaysLinkToLastBuild: false, keepAll: true, reportDir: 'Source/AppFramework/appFramework/build/reports/coverage/AppFrameworkHamburger/debug', reportFiles: 'index.html', reportName: 'coverage debug AppFrameworkHamburger']) 
                publishHTML([allowMissing: false, alwaysLinkToLastBuild: false, keepAll: true, reportDir: 'Source/AppFramework/appFramework/build/reports/coverage/AppFrameworkTabbed/debug', reportFiles: 'index.html', reportName: 'coverage debug AppFrameworkTabbed']) 
