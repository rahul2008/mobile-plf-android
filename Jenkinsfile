        ...
        stage('Publish PSRA apk') {
            ...
            steps {
                sh '''#!/bin/bash -le
                    ...
                    curl -L -u 320049003:AP2gksEi925P3bnBaTep4qaR9fb -X PUT ${PSRA_APK_NAME} -T Source/rap/Source/AppFramework/appFramework/build/outputs/apk/psraRelease/referenceApp-psraRelease.apk
                '''
...
def DeployingLeakCanaryArtifacts() {
    ...
    def shellcommand = '''#!/bin/bash -l
        ...
        then
            ...
            curl -L -u 320049003:AP2gksEi925P3bnBaTep4qaR9fb -X PUT $ARTIFACTORY_URL/$ARTIFACTORY_REPO/com/philips/cdp/referenceApp/LeakCanary/ -T $APK_NAME
...
def DeployingConnectedTestsLogs() {
    ...
    def shellcommand = '''#!/bin/bash -l
        ...
        do
            curl -L -u 320049003:AP2gksEi925P3bnBaTep4qaR9fb -X PUT $ARTIFACTORY_URL/$ARTIFACTORY_REPO/logs/ -T $LOGS
        done
...
def DeployingJavaDocs() {
    ...
    def shellcommand = '''#!/bin/bash -l
        ...
        curl -L -u 320049003:AP2gksEi925P3bnBaTep4qaR9fb -X PUT $ARTIFACTORY_URL/$ARTIFACTORY_REPO/com/philips/cdp/AppInfra/$platformVersion/ -T ./Source/ail/Documents/External/AppInfra-api.zip
        curl -L -u 320049003:AP2gksEi925P3bnBaTep4qaR9fb -X PUT $ARTIFACTORY_URL/$ARTIFACTORY_REPO/com/philips/cdp/digitalCare/$platformVersion/ -T ./Source/dcc/Documents/External/digitalCare-api.zip
        
        curl -L -u 320049003:AP2gksEi925P3bnBaTep4qaR9fb -X PUT $ARTIFACTORY_URL/$ARTIFACTORY_REPO/com/philips/cdp/iap/$platformVersion/ -T ./Source/iap/Documents/External/iap-api.zip
        
        curl -L -u 320049003:AP2gksEi925P3bnBaTep4qaR9fb -X PUT $ARTIFACTORY_URL/$ARTIFACTORY_REPO/com/philips/cdp/product-registration-lib/$platformVersion/ -T ./Source/prg/Documents/External/product-registration-lib-api.zip
        curl -L -u 320049003:AP2gksEi925P3bnBaTep4qaR9fb -X PUT $ARTIFACTORY_URL/$ARTIFACTORY_REPO/com/philips/cdp/productselection/$platformVersion/ -T ./Source/pse/Documents/External/productselection-api.zip
