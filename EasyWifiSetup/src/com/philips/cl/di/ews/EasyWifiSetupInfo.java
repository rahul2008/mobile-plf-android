...
public class EasyWifiSetupInfo {
	...
	StringEntity toJson() throws Exception{
		 JSONObject holder = new JSONObject();
		 holder.put("ssid", mCurrentSsid);
		 if(mPassword!=null && mPassword.equals("")==false){
			 String s = Base64.encodeToString(encrypt(mPassword.getBytes()), Base64.DEFAULT);
	...
	public UrlEncodedFormEntity toWifiFormParams() throws UnsupportedEncodingException {
		List<BasicNameValuePair> nameValuePair = new ArrayList<BasicNameValuePair>(2);        
	...
	public UrlEncodedFormEntity toDeviceFormParams() throws UnsupportedEncodingException {
		List<BasicNameValuePair> nameValuePair = new ArrayList<BasicNameValuePair>(2);        
	...
	public StringEntity toJsonDevice() throws JSONException, UnsupportedEncodingException{
		 JSONObject holder = new JSONObject();
	...
	public void calculateKey(String hellman) {
        ...
        mKey = y.toString(16);//toString();//Arrays.copyOf(y.toByteArray(), 16).toString();
	}
