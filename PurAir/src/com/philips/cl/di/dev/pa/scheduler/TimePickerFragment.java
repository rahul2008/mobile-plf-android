...
public class TimePickerFragment extends DialogFragment implements
	...
	public Dialog onCreateDialog(Bundle savedInstanceState) {
		ALog.i("Scheduler",
				"TimePickerFragment::onCreateDialog method beginning is called");
		...
		// mListener, hour, minute, false);
		TimePickerDialog picker = new TimePickerDialog(wrapper, mListener,
				hour, minute, false);
		picker.setCanceledOnTouchOutside(true);
		ALog.i("Scheduler",
				"TimePickerFragment::onCreateDialog method ending is called");
		return picker;
	}
