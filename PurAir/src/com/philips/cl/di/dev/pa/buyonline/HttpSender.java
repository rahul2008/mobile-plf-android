...
public class HttpSender {
	...
	public enum ResponseState {
		NORMAL, // ç½‘ç»œæ­£å¸¸,æ­£å¸¸è¿”å›ž
		ERROR_CONN, // ç½‘ç»œè¿žæŽ¥å¼‚å¸¸
		ERROR_SERVER, // æœ�åŠ¡å™¨ç«¯é”™è¯¯
		ERROR_PARSE, // è§£æž�é”™è¯¯
		ERROR_TOKEN_INVALIDATE, //tokenå¤±æ•ˆ 
	...
	public String sendFile(Map<String, String> map, File file, String action) {
        ...
        HttpResponse response = execute(httpPost, action);
        if (response != null) {
