...
public class DrawerAdapter implements DrawerListener {
	...
	public enum DrawerEvent {
		DRAWER_OPENED, DRAWER_CLOSED, DRAWER_SLIDE_END
	}
	...
	public void removeDrawerListener(DrawerEventListener listener) {
		ALog.i(ALog.DRAWER, "DrawerAdapter#removeDrawerListener listener "
				+ listener);
	...
	public void onDrawerClosed(View drawerView) {
		ALog.i(ALog.DRAWER, "DrawerAdapter$onDrawerClosed");
		notifyListeners(DrawerEvent.DRAWER_CLOSED, drawerView);
	}

	@Override
	public void onDrawerOpened(View drawerView) {
		ALog.i(ALog.DRAWER, "DrawerAdapter$onDrawerOpened");
	...
	public void onDrawerSlide(View drawerView, float slideOffset) {
		if (slideOffset <= 0) {
			ALog.i(ALog.DRAWER, "DrawerAdapter$onDrawerSlide");
	...
	public void onDrawerStateChanged(int newState) {
		ALog.i(ALog.DRAWER, "DrawerAdapter$onDrawerStateChanged newState "
				+ newState);
	}
