...
public class CancelDialogFragment extends DialogFragment {
	...
	public void onActivityCreated(Bundle arg0) {
		...
		((TextView) getView().findViewById(R.id.tv_cancel_wifi_setup_message))
		...
		cancelWifiYes.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				switch (index) {
				case REMOTE:
					PairingHandler pm = new PairingHandler(
							(MainActivity) getActivity(), PurifierManager
									.getInstance().getCurrentPurifier());
