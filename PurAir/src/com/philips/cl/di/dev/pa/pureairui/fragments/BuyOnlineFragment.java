...
public class BuyOnlineFragment extends ListFragment{
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		list.add(new ProductDto("Philips Smart Air Purifier", "000 000 000", "Philips.com.cn", R.drawable.purifier));
		list.add(new ProductDto("Pre-Filter", "000 000 000", "Philips.com.cn", R.drawable.filter));
		list.add(new ProductDto("Multi Care Filter", "000 000 000", "Philips.com.cn", R.drawable.multi_care));
		list.add(new ProductDto("Active Carbon", "000 000 000", "Philips.com.cn", R.drawable.carbon_filter));
		list.add(new ProductDto("HEPA Filter", "000 000 000", "Philips.com.cn", R.drawable.hepa_filter));
	...
	class BuyDataAdapter extends ArrayAdapter<ProductDto> {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (convertView == null) {
				view = mInflater.inflate(R.layout.buy_online_list_item, parent, false);
			} else {
				view = convertView;
			}

			ProductDto item = getItem(position);
			TextView productName=(TextView)view.findViewById(R.id.lbl_product_name);	        
			TextView productPrice=(TextView)view.findViewById(R.id.lbl_product_price);	        
			TextView availability=(TextView)view.findViewById(R.id.lbl_availability);          
			...
			availability.setText("available to purchase from "+item.getAvailability());
