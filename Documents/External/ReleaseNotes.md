...
* CommLib - \#18943 On wifi switch, change from local request to remove request
* CommLib - \#18964 On wifi switch, change clear the devices found on the local network
