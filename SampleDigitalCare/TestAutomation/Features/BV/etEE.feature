Feature:Submitting the product review with ET-EE as combination
...
Then I touch on the spinner1
Then I touch on "Estonia (et)" language
Then I touch on the spinner2
Then I touch on "EE" country
Then I touch the ctn
Then I enter into ctn area1
